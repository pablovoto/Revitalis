		...
		<div className="navbar bg-base-100 shadow-lg sticky top-0 z-50">
			...
			<div className="navbar-center hidden lg:flex">
				<ul className="menu menu-horizontal px-1">
					<li>
						<Link to="/" className="btn btn-ghost font-bold">Inicio</Link>
					</li>
					<li className="dropdown dropdown-hover">
						<div tabIndex={0} role="button" className="btn btn-ghost font-bold">
							Servicios
						</div>
						<ul tabIndex={0} className="menu menu-md dropdown-content bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
							<li>
								<Link to="/depilacion-laser">Depilación Láser</Link>
							</li>
							<li>
